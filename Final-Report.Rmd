...
1. Linear model without interaction
2. Linear models with one interaction term on each combination of predictor variables
3. Linear models with two interaction terms
4. Linear model with all possible interaction terms
